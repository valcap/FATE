...
\begin{center}
\vspace{2cm}\Huge{Issued: Fri, 05-05-2023\\ 06:34 Paranal local time}
\HRule \\[0.1cm]
\end{center}
...
\caption{\textbf{Wind speed} ($m s^{-1}$): (a) STANDARD CONFIGURATION, (b) WITH AR, (c) PERSISTENCE.}
\label{fig:ws}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
...
\hline
\end{tabular}
\caption{Statistics for variables processed with AR}
\end{center}
\end{table}
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Wind speed ($m s^{-1}$) processed with AR}
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Relative humidity (percent) processed with AR}
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Precipitable water vapor (mm) processed with AR}
...
\hline
\multicolumn{5}{l}{Sample size: ; PC=\%; EBD=\%; POD1=\%; POD2=\%; POD3=\%}
\end{tabular}
\end{center}
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Total seeing (arcsec) processed with AR and accuracy 0.0}
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Total seeing (arcsec) processed with AR and accuracy 0.10}
\label{tab:contingencyseeAFT}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[]
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Total seeing (arcsec) processed with AR and accuracy 0.24}
\label{tab:contingencyseeAFT}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[]
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Coeherence time (ms) processed with AR and accuracy 0.0}
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Coeherence time (ms) processed with AR and accuracy 1.22}
\label{tab:contingencytauAFT}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[]
...
\multicolumn{1}{c}{\multirow{3}{*}{Model data}}  & glf $<$ 0.6             & 4369                & 3882                       & 3308              \\
                                                 ...
                                                 & glf $>$ 0.7             & 354                & 592                       & 970              \\
\hline
\multicolumn{5}{l}{Sample size: ; PC=38.3\%; EBD=21.2\%; POD1=75.9\%; POD2=22.3\%; POD3=16.9\%}
\end{tabular}
\end{center}
...
\multicolumn{1}{c}{\multirow{3}{*}{Model data}}  & glf $<$ 0.6             & 5041                & 935                       & 43              \\
                                                 ...
                                                 & glf $>$ 0.7             & 40                & 682                       & 4809              \\
\hline
\multicolumn{5}{l}{Sample size: ; PC=81.0\%; EBD=0.5\%; POD1=87.6\%; POD2=71.9\%; POD3=83.5\%}
\end{tabular}
\end{center}
\caption{Contingency table for variable Ground layer fraction (dimensionless) processed with AR and accuracy 0.0}
...
\end{tabular}
\end{center}
\caption{Contingency table for variable Ground layer fraction (dimensionless) processed with AR and accuracy 0.14}
\label{tab:contingencyglfAFT}
\end{table}
%%%%%%%%%%%%%%%%%%%%
\clearpage
