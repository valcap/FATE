...
\parbox{5.5cm}{\large{\textbf{FATE MONTHLY REPORT}}}
...
\FrontRule \\[1.4cm]
\Large{{Performance assessment \\\today}}
\end{center}

\begin{center}
\vspace{6cm}
\parbox{4.5cm}{\includegraphics[width=4.5cm]{/home/report/SCRIPTS/LOGOS/fate_logo_11def}}
...
\cellcolor[HTML]{C0C0C0}\textbf{ESO:} ftp access ESO - INPUT                   & 8           & 34   \\
...
\cellcolor[HTML]{C0C0C0}\textbf{ESO:} server OUTPUT                            & 8           & 34   \\
\cellcolor[HTML]{C0C0C0}\textbf{FATE:} model: explosion of simulations         & 8           & 34   \\
