...
\begin{center}
\vspace{2cm}\Huge{Issued: Mon, 08-05-2023\\ 11:08 Paranal local time}
\HRule \\[0.1cm]
\end{center}
...
\caption{total seeing (arcsec): (a) STANDARD CONFIGURATION, (b) WITH AR (1H), (c) PERSISTENCE.}
\label{fig:see}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
...
\cellcolor[HTML]{C0C0C0}WD  &                                 &                                 &   &    12.471 \\
