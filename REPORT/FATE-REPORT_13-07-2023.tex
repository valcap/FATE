...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\textbf{FATE - Monthly report}}
%\usepackage{lastpage}
...
\begin{center}
\hspace{1.5cm}
\parbox{5.5cm}{\includegraphics[width=4.5cm]{/home/report/SCRIPTS/LOGOS/INAF_Arcetri_colore}}
\hspace{.3cm}
\parbox{5.5cm}{\includegraphics[width=4.5cm]{/home/report/SCRIPTS/LOGOS/logoLaMMA}}
\hspace{.1cm}
\vspace{1.2cm}
\end{center}
\end{figure}
...
\begin{center}
\FrontRule \\[0.4cm]
\Huge{\textbf{FORECAST SYSTEM FOR\\ATMOSPHERE AND TURBULENCE\\at the VERY LARGE TELESCOPE\\}}
\FrontRule \\[1.4cm]
\Large{\textbf{Performance assessment\\\monthyeardate}}
\end{center}

\begin{center}
\vspace{4cm}
\hspace{.3cm}
\parbox{5.5cm}{\includegraphics[width=4.5cm]{/home/report/SCRIPTS/LOGOS/fate_logo_11def}}
\hspace{.3cm}
\\\vspace{2cm}\normalsize{PO102958/ESO/20/95952/FLAB}
\HRule \\[0.1cm]
\end{center}
...
\cellcolor[HTML]{C0C0C0}\textbf{ESO:} ftp access ESO - INPUT                   & 8           & 32   \\
...
\cellcolor[HTML]{C0C0C0}\textbf{ESO:} server OUTPUT                            & 8           & 32   \\
\cellcolor[HTML]{C0C0C0}\textbf{FATE:} model: explosion of simulations         & 8           & 32   \\
