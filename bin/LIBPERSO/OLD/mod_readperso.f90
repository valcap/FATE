...
!******************************************************************************
  ...
  if (ncol .le. 7) then
    print*, '!!! read_generic_ascii_file: file ',trim(namefile),' has a wrong number of columns'
    call exit(1)
  end if
...
!******************************************************************************
  ...
  if (ncol .le. 7) then
    print*, '!!! read_eso_database_file: file ',trim(namefile),' has a wrong number of columns'
    call exit(1)
  end if
