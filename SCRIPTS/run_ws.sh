...
\caption{\textbf{$descri} ($unitof): (a) STANDARD CONFIGURATION, (b) WITH AR (1H), (c) PERSISTENCE.}
\label{fig:$prefix}
\end{figure}
EOF
#
...
my_nice_caption='Contingency table for \textbf{'$descri'} ('$unitof') in standard configuration'
...
my_nice_caption='Contingency table for variable '$descri' ('$unitof') processed with AR (1H)'
