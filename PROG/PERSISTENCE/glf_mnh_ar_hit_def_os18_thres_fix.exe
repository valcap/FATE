#! /bin/bash
export JOB=glf_mnh_ar_hit_def_os18_thres_fix
export IDELTA=10
export GG=5GG
export HH=1H
...
"${STARTIN}"
'list_GLF_${GG}.txt'
'glf_sim_mnh_ar_dimm_${STARTMINUTE}_${ENDMINUTE}_BEF_os18_thres_fix.ps/cps'
'glf_sim_mnh_ar_dimm_${STARTMINUTE}_${ENDMINUTE}_AFT_os18_thres_fix.ps/cps'
EOF
