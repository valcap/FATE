...
#############################################
# 2. TODO Wind Direction 0-90 (variable prefix is 'wd')
...
if [ $VARIN == 'wd' ]; then
  ...
  export ROOT_WS=$DATA_PERS_DIR"/WS_TREATED/"
  export STARTIN=$PREFIX_UC"_PERSIST_"
...
"${STARTIN_WS}"
'$FILE_LIST'
'$FIGS_ROOT_DIR/${prefix_lc}_sim_mnh_ar_dimm_${STARTMINUTE}_${ENDMINUTE}_BEF_stan_0_90_per.ps/cps'
'$FIGS_ROOT_DIR/${prefix_lc}_sim_mnh_ar_dimm_${STARTMINUTE}_${ENDMINUTE}_AFT_stan_0_90_per.ps/cps'
EOF
  rm -f ${JOB}.exe
  rm -f out_scatter_for_python_bef.dat out_scatter_for_python_aft.dat
  #
