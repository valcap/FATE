...
WRITE (*,1003) 'LOGINFO BIAS_SEE_MOD_BEF=',BIAS_SEE_MOD_BEF
WRITE (*,1003) 'LOGINFO RMSE_SEE_MOD_BEF=',RMSE_SEE_MOD_BEF
WRITE (*,1003) 'LOGINFO SIGMA_SEE_MOD_BEF=',SIGMA_SEE_MOD_BEF
PRINT*,'INC_SEE_MOD_BEF=',INC_SEE_MOD_BEF
PRINT*,'LOGINFO BEF NbLines_TOT=',NbLines_TOT_Pix
...
WRITE (*,1003) 'LOGINFO BIAS_SEE_MOD_AFT=',BIAS_SEE_MOD_AFT
WRITE (*,1003) 'LOGINFO RMSE_SEE_MOD_AFT=',RMSE_SEE_MOD_AFT
WRITE (*,1003) 'LOGINFO SIGMA_SEE_MOD_AFT=',SIGMA_SEE_MOD_AFT
...
CALL PGLABEL('OBS: total seeing (arcsec)','MNH: total seeing (arcsec)','STANDARD CONFIGURATION')
DO I=1,NbNights
 DO J=1,NbPix
