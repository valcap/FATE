...
WRITE (*,1003) 'LOGINFO BIAS_TAU_MOD_BEF=',BIAS_TAU_MOD_BEF
WRITE (*,1003) 'LOGINFO RMSE_TAU_MOD_BEF=',RMSE_TAU_MOD_BEF
WRITE (*,1003) 'LOGINFO SIGMA_TAU_MOD_BEF=',SIGMA_TAU_MOD_BEF
...
WRITE (*,1003) 'LOGINFO BIAS_TAU_MOD_AFT=',BIAS_TAU_MOD_AFT
WRITE (*,1003) 'LOGINFO RMSE_TAU_MOD_AFT=',RMSE_TAU_MOD_AFT
WRITE (*,1003) 'LOGINFO SIGMA_TAU_MOD_AFT=',SIGMA_TAU_MOD_AFT
...
CALL PGLABEL('OBS: coherence time (ms)','MNH: coherence time (ms)','STANDARD CONFIGURATION')
DO I=1,NbNights
 DO J=1,NbPix
