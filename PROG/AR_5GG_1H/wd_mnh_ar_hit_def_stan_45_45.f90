...
CHARACTER(7)                         :: BIAS_MOD_BEFc,BIAS_MOD_AFTc
...
WRITE(BIAS_MOD_BEFc,'(f6.2)')BIAS_MOD_BEF
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!write (*,6000) 'LOGINFO CONTTABLE AFT ROW0 X<',THRES1,
!THRES1,'<X<',THRES2,
!THRES2,'<X<',THRES3,
!'X>',THRES3
!6000 format (a200,f4.1,2x,
!f4.1,a3,f4.1,2x,
!f4.1,a3,f4.1,2x,
!a2,f4.1)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
