...
PRINT*,'LOGINFO BIAS_MOD_BEF=',BIAS_MOD_BEF
PRINT*,'LOGINFO RMSE_MOD_BEF=',RMSE_MOD_BEF
PRINT*,'LOGINFO SIGMA_MOD_BEF=',SIGMA_MOD_BEF
...
PRINT*,'LOGINFO BIAS_MOD_AFT=',BIAS_MOD_AFT
PRINT*,'LOGINFO RMSE_MOD_AFT=',RMSE_MOD_AFT
PRINT*,'LOGINFO SIGMA_MOD_AFT=',SIGMA_MOD_AFT
