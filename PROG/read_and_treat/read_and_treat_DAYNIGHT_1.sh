...
# _LastMonth
    if [ $daygg == "night" ]; then
        ...
        ls SEE_ARevol_${hiter}_${NEWGG}${fcst_lenght}_202309*.dat |cut -d"_" -f5|cut -d"." -f1|sort|uniq > ${LISTA}
        LISTA="$OUTPUTDIR/list_TAU_LastMonth.txt"
        ls TAU_ARevol_${hiter}_${NEWGG}${fcst_lenght}_202309*.dat |cut -d"_" -f5|cut -d"." -f1|sort|uniq > ${LISTA}
        LISTA="$OUTPUTDIR/list_GLF_LastMonth.txt"
        ls GLF_ARevol_${hiter}_${NEWGG}${fcst_lenght}_202309*.dat |cut -d"_" -f5|cut -d"." -f1|sort|uniq > ${LISTA}
    fi
    LISTA="$OUTPUTDIR/list_PWV_LastMonth.txt"
    ls PWV_ARevol_${hiter}_${NEWGG}${fcst_lenght}_202309*.dat |cut -d"_" -f5|cut -d"." -f1|sort|uniq > ${LISTA}
    LISTA="$OUTPUTDIR/list_RH_LastMonth.txt"
    ls RH_ARevol_${hiter}_${NEWGG}${fcst_lenght}_202309*.dat |cut -d"_" -f5|cut -d"." -f1|sort|uniq > ${LISTA}
    LISTA="$OUTPUTDIR/list_WS_LastMonth.txt"
    ls WS_ARevol_${hiter}_${NEWGG}${fcst_lenght}_202309*.dat |cut -d"_" -f5|cut -d"." -f1|sort|uniq > ${LISTA}
    LISTA="$OUTPUTDIR/list_WD_LastMonth.txt"
    ls WD_ARevol_${hiter}_${NEWGG}${fcst_lenght}_202309*.dat |cut -d"_" -f5|cut -d"." -f1|sort|uniq > ${LISTA}
